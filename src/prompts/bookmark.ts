...
- Each item must have a \`type\` field with one of these values:
  ...
  - \`"play"\`: for activities or venues mainly for eating, drinking, playing, or entertainment, such as restaurants, cafés, bars, izakayas, ballparks, amusement facilities, onsen, ski areas, and similar “do / experience” places.
...
- For each item, choose a \`type\` (\\"sight\\", \\"shopping\\", or \\"play\\").
